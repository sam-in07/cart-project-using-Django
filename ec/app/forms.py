...
class LoginForm(AuthenticationForm):
    ...
    password =forms.CharField(widget=forms.PasswordInput(attrs={'autocomplete':'current-password','class':'from-control'}))
...
class MySetPasswordForm(SetPasswordForm):
    new_password1 = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={
                'autocomplete': 'new-password',  # Corrected to 'new-password'
                'class': 'form-control'
            }
        )
    )
